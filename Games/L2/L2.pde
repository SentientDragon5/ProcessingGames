...
void setup(){
  ...
  tilemap = new TileMap("collide.csv");
  
  red_brick = loadImage("CaveTileset/caves_94.png");
  brown_brick = loadImage("CaveTileset/caves_94.png");
  crate = loadImage("CaveTileset/caves_94.png");
  snow = loadImage("CaveTileset/caves_90.png");
...
void updateAll()
{
  ...
  resolvePlatformCollisions(player, tilemap.tiles);
